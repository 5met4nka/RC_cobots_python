...
from API.source.models.constants import (
    CTRLR_MAX_DIG_IN_BYTES, CTRLR_MAX_DIG_OUT_BYTES, CTRLR_MAX_AN_IN,
    CTRLR_MAX_AN_OUT, JOINTS_COUNT
)
...
class RTD:
    ...
    # space (6d)
    move_des_x: tuple = JOINTS_COUNT  # traj. gen. desired position for cart.
    # space(6d)
    move_des_xd: tuple = JOINTS_COUNT  # traj. gen. desired velocity for cart.
    # space (6d)
    ...
    ne_tq: tuple = JOINTS_COUNT  # predicted gravity/coriolis (newton-euler
    # algorithm) torque (6d)
